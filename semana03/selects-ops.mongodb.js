...
/* SELECIONA DOCUMENTOS COM O USO DO OPERADOR MAIOR $gt */
// db['Livraria'].find({valor:{$gt:100}});

/* SELECIONA DOCUMENTOS COM O USO DO OPERADOR MENOR $lt */
// db["Livraria"].find({ valor: { $lt: 110 } });

/* DEFININDO UM INTERVALO ENTRE VALORES: */
// maior ou igual($gte), menor ou igual($lte)
...
/* OPERADOR LÓGICO OR: */
// db["Livraria"].find({
//   $or: [{ categoria: { $eq: "Fantasia Heroica" } }, { valor: { $lte: 100 } }],
// });
